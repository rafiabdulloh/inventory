<table class="table table-hover box tmpl" id="stock">
	...
	<button type="button" class="btn btn-inline-primary tmpl insert-stock" data-toggle="modal" data-target="#exampleModal">Tambahkan stok</button>
	<thead>
        <th>No</th>
        <th>Name</th>
        <th>Stok barang</th>
    ...
    <tr>
		...
		<td><?= $brg['alias']?></td>
		<td><?= $brg['stok']?></td>
		<td class="trash" style="padding-top:17px">
            <a href="" style="color:#e61a1a">
